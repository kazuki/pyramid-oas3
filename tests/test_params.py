...
class ParameterTests(unittest.TestCase):
    ...
    def test_in_query(self):
        ...
        self.app.get('/test_in_query?oneOf2=A', status=200)
        self.app.get('/test_in_query?oneOf2=B', status=400)
        self.app.get('/test_in_query?oneOf2=1', status=200)
        self.app.get('/test_in_query?oneOf2=-1', status=400)
        self.app.get('/test_in_query?oneOf2=true', status=200)
        self.app.get('/test_in_query?oneOf2=false', status=200)
        self.app.get('/test_in_query?oneOf2=3.14', status=400)
